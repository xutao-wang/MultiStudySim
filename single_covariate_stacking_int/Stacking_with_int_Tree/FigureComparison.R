case_0.1 <- readRDS('~/Desktop/master_project/base_case/single_covariate_stacking_int/Stacking_with_int_Tree/stacking_with_int_oldd/case_0.1.rds')
case_0.5 <- readRDS('~/Desktop/master_project/base_case/single_covariate_stacking_int/Stacking_with_int_Tree/stacking_with_int_oldd/case_0.5.rds')
case_1 <- readRDS('~/Desktop/master_project/base_case/single_covariate_stacking_int/Stacking_with_int_Tree/stacking_with_int_oldd/case_1.rds')
case_4 <- readRDS('~/Desktop/master_project/base_case/single_covariate_stacking_int/Stacking_with_int_Tree/stacking_with_int_oldd/case_4.rds')
...
get_long_data <- function(output,size){
  ...
  tt_bagtree <- cbind(tidyr::gather(data.frame(do.call(rbind,lapply(output,'[[',4)))[,c(1:5)], weighting, measurement, stacking:merge, factor_key=TRUE),'treebag')
...
get_learner_plotting(dat_total,'One Covariate, 10 studies','X Variance')
