...
case_0 <- readRDS('~/Desktop/master_project/base_case/base_sample_size/case_300.RDS')
case_1 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SampleSize300/case_1.RDS')
case_3 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SampleSize300/case_3.RDS')
case_5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SampleSize300/case_5.RDS')
case_7 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SampleSize300/case_7.RDS')
case_9 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SampleSize300/case_9.RDS')
...
get_learner_plotting(dat_total,'Variance of Beta Sample Size 300','Beta Sigma')
