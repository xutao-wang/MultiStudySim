...
mu_beta_1.1 <- matrix(rep(get_sep_unif(0.5,3,-3,-0.5),m),nrow = m,ncol=p,byrow=T);mu_beta_1.1
...
#saveRDS(case_0, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_0.rds")
#saveRDS(case_0.25, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_0.25.rds")
#saveRDS(case_0.5, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_0.5.rds")
#saveRDS(case_0.75, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_0.75.rds")
#saveRDS(case_1, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_1.rds")
#saveRDS(case_1.5, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_1.5.rds")
#saveRDS(case_2, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_2.rds")
#saveRDS(case_2.5, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_2.5.rds")
#saveRDS(case_3, file = "~/MultiSim/result/base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_3.rds")

case_0_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_0.RDS')
case_0.25_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_0.25.RDS')
case_0.5_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_0.5.RDS')
case_0.75_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_0.75.RDS')

case_1_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_1.RDS')
case_1.5_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_1.5.RDS')
case_2_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_2.RDS')
case_2.5_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_2.5.RDS')
case_3_k <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/SS100_Sigma_0-3_BetaValue_0.5-3/case_3.RDS')
...
dat_0_k <- get_long_data(case_0_k,0)
dat_0.25_k <- get_long_data(case_0.25_k,0.25)
dat_0.5_k <- get_long_data(case_0.5_k,0.5)
dat_0.75_k <- get_long_data(case_0.75_k,0.75)
dat_1_k <- get_long_data(case_1_k,1)
dat_1.5_k <- get_long_data(case_1.5_k,1.5)
dat_2_k <- get_long_data(case_2_k,2)
dat_2.5_k <- get_long_data(case_2.5_k,2.5)
dat_3_k <- get_long_data(case_3_k,3)

dat_total_k <- rbind(dat_0_k,dat_0.25_k,dat_0.5_k,dat_0.75_k,dat_1_k,dat_1.5_k,dat_2_k,dat_2.5_k,dat_3_k)
...
get_learner_plotting(dat_total_k,'Beta Value [-3,-0.5]&[0.5,3]','Beta Sigma')
...
grid.arrange(get_plot_ratio(dat_total_k,'elnet'),get_plot_ratio(dat_total_k,'Nnet'),
             get_plot_ratio(dat_total_k,'boost'),get_plot_ratio(dat_total_k,'rf'),
             ncol=2,top=textGrob('Beta Value [-3,-0.5] & [0.5,3] Sampe Size 100',gp=gpar(fontsize=20,font=3)))
