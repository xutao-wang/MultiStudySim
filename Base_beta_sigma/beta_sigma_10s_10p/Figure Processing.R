case_0 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_0.RDS')
case_0.25 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_0.25.RDS')
case_0.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_0.5.RDS')
case_0.75 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_0.75.RDS')

case_1 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_1.RDS')
case_1.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_1.5.RDS')
case_2 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_2.RDS')
case_2.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_2.5.RDS')
case_3 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_10p/beta_sigma_10s_10p/case_3.RDS')
...
get_learner_plotting <- function(dat_total,title,xlab){
  ...
  p_rf <- ggplot(dat_rf_plot, aes(x=Size, y=measurement, color=weighting)) + 
    ...
    scale_x_continuous(breaks = dat_rf_plot$Size) + theme(axis.text.x = element_text(angle = 0), legend.text = element_text(size = 15))
...
get_learner_plotting(dat_total,NULL,'Beta Sigma')
...
get_plot_ratio <- function(dat_total,learner){
  ...
  p_ratio <- ggplot(dat_plot, aes(x=Size, y=measurement, color=weighting)) +
    ...
    geom_line(position = pd) + xlab('Beta Sigma') + ylab("RMSE_Ratio") +
...
grid.arrange(get_plot_ratio(dat_total,'elnet'),get_plot_ratio(dat_total,'Nnet'),
             ...
             ncol=2,top=textGrob(NULL,gp=gpar(fontsize=20,font=3)))
...
grid.arrange(hist_plot_compare(dat_0,'0', 'merge','stacking','rf'),hist_plot_compare(dat_0.25,'0.25', 'merge','stacking','rf'),
             ...
             ncol=3,top=textGrob('Histogram of Stacking vs. Merge in Random Forest 10s_10p',gp=gpar(fontsize=20,font=3)))
