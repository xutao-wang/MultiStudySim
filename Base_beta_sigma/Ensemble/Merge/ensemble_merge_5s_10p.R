...
#test1 = ensemble_learning_merge(lst,dat_train,dat_test,nk_train)
...
case_0 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_0[[x]])[[1]],
                                                                       get_input_dat(dat_input_0[[x]])[[2]],
                                                                       lapply(test_0, '[[',1),nk_train))
saveRDS(case_0, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_0.rds")

case_0.25 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_0.25[[x]])[[1]],
                                                                          get_input_dat(dat_input_0.25[[x]])[[2]],
                                                                          lapply(test_0.25, '[[',1),nk_train))
saveRDS(case_0.25, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_0.25.rds")

case_0.5 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_0.5[[x]])[[1]],
                                                                         get_input_dat(dat_input_0.5[[x]])[[2]],
                                                                         lapply(test_0.5, '[[',1),nk_train))
saveRDS(case_0.5, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_0.5.rds")

case_0.75 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_0.75[[x]])[[1]],
                                                                          get_input_dat(dat_input_0.75[[x]])[[2]],
                                                                          lapply(test_0.75, '[[',1),nk_train))
saveRDS(case_0.75, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_0.75.rds")

case_1 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_1[[x]])[[1]],
                                                                       get_input_dat(dat_input_1[[x]])[[2]],
                                                                       lapply(test_1, '[[',1),nk_train))
saveRDS(case_1, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_1.rds")

case_1.5 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_1.5[[x]])[[1]],
                                                                         get_input_dat(dat_input_1.5[[x]])[[2]],
                                                                         lapply(test_1.5, '[[',1),nk_train))
saveRDS(case_1.5, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_1.5.rds")

case_2 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_2[[x]])[[1]],
                                                                       get_input_dat(dat_input_2[[x]])[[2]],
                                                                       lapply(test_2, '[[',1),nk_train))
saveRDS(case_2, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_2.rds")

case_2.5 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_2.5[[x]])[[1]],
                                                                         get_input_dat(dat_input_2.5[[x]])[[2]],
                                                                         lapply(test_2.5, '[[',1),nk_train))
saveRDS(case_2.5, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_2.5.rds")

case_3 <- sfLapply(1:length(dat_input_1),function(x) ensemble_learning_merge(get_input_dat(dat_input_3[[x]])[[1]],
                                                                       get_input_dat(dat_input_3[[x]])[[2]],
                                                                       lapply(test_3, '[[',1),nk_train))
saveRDS(case_3, file = "~/MultiSim/result/ensemble_merge_5s_10p/case_3.rds")
