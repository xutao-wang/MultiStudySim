...
MultiStudySim <- function(k,nk,p,m,mu_x,SIG,pii,mu_beta,sigma_beta){
  ...
  output_Y_list <- lapply(1:k,function(x) 
    x_vec_list[[x]]%*%beta_vec_list[[x]] + x_vec_list[[x]][,1]*x_vec_list[[x]][,2]+ rnorm(nrow(x_vec_list[[x]]),0,1))
...
saveRDS(case_0, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_0.rds")
...
saveRDS(case_0.25, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_0.25.rds")
...
saveRDS(case_0.5, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_0.5.rds")
...
saveRDS(case_0.75, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_0.75.rds")
...
saveRDS(case_1, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_1.rds")
...
saveRDS(case_1.5, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_1.5.rds")
...
saveRDS(case_2, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_2.rds")
...
saveRDS(case_2.5, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_2.5.rds")
...
saveRDS(case_3, file = "~/MultiSim/result/beta_sigma_5s_10p/Interaction/oneInt/case_3.rds")
