...
saveRDS(case_0, file = "~/MultiSim/result/beta_sigma_10s_5p/case_0.rds")
saveRDS(case_0.25, file = "~/MultiSim/result/beta_sigma_10s_5p/case_0.25.rds")
saveRDS(case_0.5, file = "~/MultiSim/result/beta_sigma_10s_5p/case_0.5.rds")
saveRDS(case_0.75, file = "~/MultiSim/result/beta_sigma_10s_5p/case_0.75.rds")
saveRDS(case_1, file = "~/MultiSim/result/beta_sigma_10s_5p/case_1.rds")
saveRDS(case_1.5, file = "~/MultiSim/result/beta_sigma_10s_5p/case_1.5.rds")
saveRDS(case_2, file = "~/MultiSim/result/beta_sigma_10s_5p/case_2.rds")
saveRDS(case_2.5, file = "~/MultiSim/result/beta_sigma_10s_5p/case_2.5.rds")
saveRDS(case_3, file = "~/MultiSim/result/beta_sigma_10s_5p/case_3.rds")
