case_0 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_0.RDS')
case_0.25 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_0.25.RDS')
case_0.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_0.5.RDS')
case_0.75 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_0.75.RDS')

case_1 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_1.RDS')
case_1.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_1.5.RDS')
case_2 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_2.RDS')
case_2.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_2.5.RDS')
case_3 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/beta_sigma_10s_5p/beta_sigma_10s_5p/case_3.RDS')
...
get_learner_plotting(dat_total,'Beta Value [-3,-2]&[2,3],10S_5P','Beta Sigma')
...
grid.arrange(get_plot_ratio(dat_total,'elnet'),get_plot_ratio(dat_total,'Nnet'),
             ...
             ncol=2,top=textGrob('Beta Value [-3,-2] & [2,3] 10S_5P',gp=gpar(fontsize=20,font=3)))
...
grid.arrange(hist_plot_compare(dat_0,'0', 'merge','stacking','rf'),hist_plot_compare(dat_0.25,'0.25', 'merge','stacking','rf'),
             ...
             ncol=3,top=textGrob('Histogram of Stacking vs. Merge in Random Forest 10s_5p',gp=gpar(fontsize=20,font=3)))
