...
saveRDS(case_0, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_0.rds")
saveRDS(case_0.25, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_0.25.rds")
saveRDS(case_0.5, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_0.5.rds")
saveRDS(case_0.75, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_0.75.rds")
saveRDS(case_1, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_1.rds")
saveRDS(case_1.5, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_1.5.rds")
saveRDS(case_2, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_2.rds")
saveRDS(case_2.5, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_2.5.rds")
saveRDS(case_3, file = "~/MultiSim/result/wz_coef/10s_10p/lose7/case_3.rds")
