...
boost_class_all <- function(lst,dat_train,dat_test,nk_train){
  ...
  return(list(stacking=stacking_rmse_mean,stacking_norm=stacking_norm_rmse_mean,
              simp_avg=simp_avg_rmse_mean,merge=merge_rmse_mean,insamp_avg=insamp_rmse_mean,stacking_wz=stacking_wz_rmse_mean,
              nl_coef=nl,nl_coef_norm=nl_norm,nl_coef_wz=nl_wz))
}
...
mu_beta_1.1 <- matrix(rep(get_sep_unif(2,3,-3,-2),m),nrow = m,ncol=p,byrow=T)
mu_beta_1.1[,1:4] <- 0;mu_beta_1.1
...
saveRDS(case_0, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_0.rds")
saveRDS(case_0.25, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_0.25.rds")
saveRDS(case_0.5, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_0.5.rds")
saveRDS(case_0.75, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_0.75.rds")
saveRDS(case_1, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_1.rds")
saveRDS(case_1.5, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_1.5.rds")
saveRDS(case_2, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_2.rds")
saveRDS(case_2.5, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_2.5.rds")
saveRDS(case_3, file = "~/MultiSim/result/wz_coef/10s_10p/lose4/case_3.rds")
