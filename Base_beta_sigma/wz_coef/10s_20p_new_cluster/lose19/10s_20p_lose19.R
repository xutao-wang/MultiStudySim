...
mu_beta_1.1[,1:19] <- 0;mu_beta_1.1
...
saveRDS(case_0, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_0.rds")
saveRDS(case_0.25, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_0.25.rds")
saveRDS(case_0.5, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_0.5.rds")
saveRDS(case_0.75, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_0.75.rds")
saveRDS(case_1, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_1.rds")
saveRDS(case_1.5, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_1.5.rds")
saveRDS(case_2, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_2.rds")
saveRDS(case_2.5, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_2.5.rds")
saveRDS(case_3, file = "~/MultiSim/result/wz_coef/10s_50p_new_way/lose19/case_3.rds")
