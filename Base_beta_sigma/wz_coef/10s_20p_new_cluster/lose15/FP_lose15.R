case_0 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_0.RDS')
case_0.25 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_0.25.RDS')
case_0.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_0.5.RDS')
case_0.75 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_0.75.RDS')

case_1 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_1.RDS')
case_1.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_1.5.RDS')
case_2 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_2.RDS')
case_2.5 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_2.5.RDS')
case_3 <- readRDS('~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/case_3.RDS')
...
write.csv(dat_total,'~/Desktop/master_project/base_case/Base_beta_sigma/wz_coef/10s_20p_new_cluster/lose15/dat_total.csv')
...
get_plot_ratio(dat_total,'elnet','lose0')
